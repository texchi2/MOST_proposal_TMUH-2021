...
%\begin{outline}
\subsubsection{Aim 1:} Construct a Deep Learning Platform of TCGA/TCIA and TMU dataset\\
%\end{outline}
...
%%%%
%\begin{outline}
\subsubsection{Aim 2:} Construct a Deep Learning Platform of EHR Survival Analysis\\
%\end{outline}
...
\acrfull{rnn} will deal with "holistic features" from \acrshort{ehr} of Taipei Medical University Hospital (TMUH).
These patient's features should include physical, pathological, psychological data, and even more spiritual information investigated by physicians.
...
Gene expression is not an independent $X_{mrna}$. It could be correlated with other (for example):\\[0.3cm]
$X_{body}, X_{stress}, X_{fear}, X_{meaningOfLife}, X_{inflammation}, X_{empathy}$ factors.\\[0.3cm]
There is much work to be done in investigating the functional mind-body network more fully\citep{Rogers1959}.\\
...
\begin{outline}
\subsubsection{Aim 3:} Biomarkers Discovery from RNA-Seq, Whole-slide Images, and EHR from TMU dataset\\
%\end{outline}
...
Moreover, the result from Aim 2 (features extraction holistic \acrshort{ehr} at TMUH) will be used for survival analysis.

...
Data analysis was waived review and consent by the TMU Joint Institutional Review Board (IRB), as all data was being analyzed retrospectively, after de- identification. All experimental protocols were approved under the IRB protocol No. Version1.0/20210531 with TMU Joint Institutional Review Board, and all experiments were carried out in accordance with approved guidelines.
...
H\&E stained histopathology slides were digitized via a whole-slide scanner at 40x magnification for this study. An Aperio Scanscope CS scanner was used to digitize cases from the TMU cohort. 
%The Ventana iCoreo scanner was used for scanning the UHCMC/CWRU and NC data cohorts. 
40x magnification corresponds to Aperio’s slides at 0.25 μm/pixel resolution.
...
\3 \cntext{研究計畫人體試驗委員會審查費: 10,000元，修正案: 1,000元，結案: 1,000元。小計: 12,000。)}
\3 \cntext{翻譯及潤稿費}

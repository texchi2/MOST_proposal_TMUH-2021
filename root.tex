...
Since deep learning algorithm could potentially extract molecular features from pathology images, 
image-based phenotypes of cancer could be correlated with their underlying genomics data.
A HE2RNA model, developed by Schmauch and their colleague\citep{Schmauch2020},  could predict RNA-Seq profiles from whole-slide images of \acrfull{tcia}. It has been validated by CD3- and CD20-\acrshort{ihc} staining. 

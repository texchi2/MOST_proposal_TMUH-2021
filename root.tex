...
\1 Aim 1: Construct a Deep Learning Platform of TCGA/TCIA Survival Analysis\\
...
TCGA/TCPA modeling (with RNA-Seq data):\\
...
$X_1, X_2, ...X_n$ are the features extracted by HE2RNA model from whole slide images of pathology.\\[0.5cm]
...
We transfer HE2RNA model on TMU HNSCC dataset to predict RNA-Seq representation:\\
...
$X_1, X_2, ...X_n$ are the features extracted from whole slide images of pathology.\\
